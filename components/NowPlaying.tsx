...
export const NowPlaying = () => {
  ...
  return (
    <div className="pb-5">
      <link href="https://css.gg/loadbar-sound.css" rel="stylesheet"></link>
      <div className="flex items-center pb-2">
        ...
        {isPlaying && <i className="gg-loadbar-sound dark:text-white ml-2 mr-4"></i>}
        <SpanSecondary className="text-lg">– Spotify</SpanSecondary>
      </div>
      {isPlaying && (
        <div className="flex">
          <div className="pr-4">
